...
#ifndef HIGHWAYHASH_HIGHWAY_BUSH_HASH512_H_
#define HIGHWAYHASH_HIGHWAY_BUSH_HASH512_H_
...
uint64_t HighwayBushHash512(const uint64_t (&key)[8], const uint8_t* bytes,
                         const uint64_t size);

#endif  // #ifndef HIGHWAYHASH_HIGHWAY_BUSH_HASH512_H_
